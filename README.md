...
2.Import Project: Open the FoodGorilla folder in Android Studio.
3.Gradle Sync: Allow the system to fetch dependencies (Compose BOM 2024.12.01).
4.Environment: Ensure you have a valid API Key if connecting to an external OpenAPI service.
5.Deploy: Run on an emulator or physical device with API 30+.
